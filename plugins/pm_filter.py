...
from database.connections_mdb import active_connection, all_connections, delete_connection, if_active, make_active, \
    make_inactive
from info import ADMINS, AUTH_CHANNEL, AUTH_USERS, CUSTOM_FILE_CAPTION, AUTH_GROUPS, P_TTI_SHOW_OFF, FILE_REQ_CHANNEL, AUTO_DELETE, AUTO_DELETE_SECONDS, IMDB, \
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("◀ 𝘽𝘼𝘾𝙆", callback_data=f"next_{req}_{key}_{off_set}"),
             InlineKeyboardButton(f"📜𝙋𝘼𝙂𝙀𝙎 {math.ceil(int(offset) / 10) + 1} / {math.ceil(total / 10)}",
                                  callback_data="pages")]
        )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('𝑀𝑎𝑛𝑢𝑎𝑙 𝐹𝑖𝑙𝑡𝑒𝑟', callback_data='manuelfilter'),
        ...
        buttons = [[
            InlineKeyboardButton('🤖 𝑈𝑝𝑑𝑎𝑡𝑒𝑠', url='https://t.me/TGCWUpdates'),
        ...
        if settings is not None:
            buttons = [
                [
                    InlineKeyboardButton('𝑭𝒊𝒍𝒕𝒆𝒓 𝑩𝒖𝒕𝒕𝒐𝒏',
                ...
                [
                    InlineKeyboardButton('𝑭𝒊𝒍𝒆 𝑺𝒆𝒄𝒖𝒓𝒆',
                ...
                [
                    InlineKeyboardButton('𝑺𝒑𝒆𝒍𝒍 𝑪𝒉𝒆𝒄𝒌',
                                         callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}'),
                    InlineKeyboardButton('✅ Yes' if settings["spell_check"] else '❌ No',
                                         callback_data=f'setgs#spell_check#{settings["spell_check"]}#{str(grp_id)}')
                ],
                [
                    InlineKeyboardButton('𝑾𝒆𝒍𝒄𝒐𝒎𝒆', callback_data=f'setgs#welcome#{settings["welcome"]}#{str(grp_id)}'),
        ...
        if 2 < len(message.text) < 100:
            ...
            if not files:
                ...
                l = await message.reply_text(text=f"△ 𝑯𝒆𝒚 𝑩𝒖𝒅𝒅𝒚 {message.from_user.first_name} 😎,\n\n 𝑷𝒍𝒆𝒂𝒔𝒆 𝑪𝒉𝒆𝒄𝒌 𝒀𝒐𝒖𝒓 𝑺𝒑𝒆𝒍𝒍𝒊𝒏𝒈 𝒊𝒏 𝑮𝑶𝑶𝑮𝑳𝑬 𝑨𝒏𝒅 𝑺𝒆𝒂𝒓𝒄𝒉 𝑨𝒈𝒂𝒊𝒏, 𝑰𝒇 𝒏𝒐𝒕 𝑭𝒐𝒖𝒏𝒅 𝑷𝒍𝒛 𝒘𝒂𝒊𝒕 𝑰 𝒔𝒆𝒏𝒅 𝒀𝒐𝒖𝒓 𝑹𝒆𝒒𝒖𝒆𝒔𝒕 𝑻𝒐 𝑴𝒚 𝑨𝒅𝒎𝒊𝒏𝒔, 𝑻𝒉𝒆𝒚 𝑾𝒊𝒍𝒍 𝑨𝑫𝑫 𝒚𝒐𝒖𝒓 𝑭𝒊𝒍𝒆𝒔 𝑺𝒐𝒐𝒏 😇\n\n➟ 📝𝒀𝒐𝒖𝒓 𝑹𝒆𝒒𝒖𝒆𝒔𝒕𝒆𝒅 𝑵𝒂𝒎𝒆 : {search}\n\n➟ 👮 𝑹𝒆𝒒𝒖𝒆𝒔𝒕𝒆𝒅 𝑩𝒚 𝒀𝒐𝒖 : {message.from_user.first_name}☆",
                                                                                                       reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("𝑪𝒐𝒏𝒕𝒂𝒄𝒕 𝑴𝒚 𝑨𝒅𝒎𝒊𝒏", url="http://t.me/vishnumbbot"),InlineKeyboardButton("𝑩𝒐𝒕 𝑼𝒑𝒅𝒂𝒕𝒆𝒔", url="https://t.me/Tgcwupdates")],[InlineKeyboardButton("♥️𝑪𝒍𝒐𝒔𝒆 𝑻𝒉𝒊𝒔 𝑴𝑺𝑮♥️«", callback_data="close_data")]]))
