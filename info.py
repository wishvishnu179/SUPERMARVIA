...
API_ID = int(environ['API_ID', '28786884'])
API_HASH = environ['API_HASH', 'e45e49071c6f1ce834201a5611e75b81']
BOT_TOKEN = environ['BOT_TOKEN', '6691829320:AAGjyLfw2qaK2FyutAa5SeKrIKUnjGqfGvY']
...
#FSub
AUTH_CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('AUTH_CHANNELS', '-1001996186113 -1002327129494 -1002102444314').split()] # give channel id with seperate space. Ex : ('-10073828 -102782829 -1007282828')
...
FILE_REQ_CHANNEL = int(environ.get('FILE_REQ_CHANNEL', '-1002258054159'))
